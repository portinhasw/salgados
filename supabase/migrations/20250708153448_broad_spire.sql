...
-- Comentários para documentação dos códigos
COMMENT ON COLUMN pedido.status IS '1=pendente, 2=confirmado, 3=pronto, 4=entregue, 5=rejeitado';
COMMENT ON COLUMN pedido.forma_pagamento IS '1=dinheiro, 2=cartao, 3=pix';
COMMENT ON COLUMN pedido.forma_entrega IS '1=retirada, 2=entrega';