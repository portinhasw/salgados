...
CREATE TABLE IF NOT EXISTS pedido_produto (
	...
	CONSTRAINT fk_pedido_produto_pedido FOREIGN KEY (codigo_pedido) REFERENCES pedido(codigo),
...
CREATE TABLE IF NOT EXISTS delivery (
	...
	CONSTRAINT fk_delivery_pedido FOREIGN KEY (codigo_pedido) REFERENCES pedido(codigo),
